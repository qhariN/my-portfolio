    ...
    <div className='flex flex-col-reverse md:flex-row items-center gap-6 my-auto'>
      <div className='flex flex-col space-y-5'>
        ...
        <div className='space-y-2'>
          <p className='text-lg'>{t('myDescription')} <b><Typewriter words={t('iLike', { returnObjects: true })} typeSpeed={40} deleteSpeed={20} loop={false} cursorStyle={'_'} cursor={true} /></b></p>
          <p className='text-lg'>
