  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        ...
        <p className="text-lg text-slate-400">Systems Engineer in Lima, Perú</p>
      </div>
      <section>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-bold border-b-2">ABOUT ME</h2>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-bold border-b-2">EXPERIENCE</h2>
        <div>
          <h3 className="text-lg font-bold flex">Frontend Developer <span className="text-slate-400 font-normal ml-auto whitespace-nowrap">Mar 2020 - Dec 2021</span></h3>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-bold border-b-2">SKILLS</h2>
        <ul className="list-disc marker:text-teal-600 pl-5">
          ...
          <li><b>Concepts</b> - Web Application Development, REST API, Databases <span className="text-slate-400">(PostgreSQL, MySQL, SQLite)</span>, Version Control <span className="text-slate-400">(Git, Github, Gitlab)</span>, Containerization Strategy <span className="text-slate-400">(Docker)</span>, PWA, SSR, SEO, Open Graph protocol</li>
        </ul>
      </section>
      <section className="space-y-2">
        <h2 className="text-xl font-bold border-b-2">PROJECTS</h2>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-bold border-b-2">EDUCATION</h2>
        <div>
          <h3 className="text-lg font-bold flex">Bachelor of Systems Engineering <span className="text-slate-400 font-normal ml-auto whitespace-nowrap">2017 - 2021</span></h3>
          <p className="text-lg">Universidad Peruana Unión — Lima, Perú</p>
        </div>
      </section>
      <section className="space-y-2">
        <h2 className="text-xl font-bold border-b-2">LANGUAGES</h2>
        <ul className="list-disc marker:text-teal-600 pl-5">
